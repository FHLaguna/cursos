...
public class LeiloesPage {
   ...
   public boolean existe(String nomeProduto, String valor, String data, String usuario) {
      return driver.getPageSource().contains(nomeProduto) && driver.getPageSource().contains(valor)
   ...
   public boolean existe(String nomeProduto, String valor, String data) {
      return existe(nomeProduto, valor, data, "fulano");
   }
   ...
   public boolean naoPodeDarLanceNoLeilaoCriado(String donoDoLeilao) {
      WebElement href = driver.findElement(By.xpath("//table[@class='table table-hover']/tbody/tr/td[contains(text(),'"
